  ...
  return (
    <div className="min-h-screen bg-brand-ivory pt-16 lg:pt-20">
      <section className="relative overflow-hidden bg-brand-navy text-white">
        ...
        <div className="site-container relative grid gap-10 py-12 lg:grid-cols-12 lg:items-center lg:py-16">
          <div className="lg:col-span-6">
            ...
            <h1 className="mt-5 max-w-xl text-4xl font-medium leading-[.98] tracking-[-.05em] sm:text-5xl lg:text-6xl">The right cover starts with the <span className="font-serif font-normal italic text-brand-gold">right questions.</span></h1>
